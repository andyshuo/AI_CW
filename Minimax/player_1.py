...
class Player(GomokuAgent):
    def __init__(self,ID,BOARDSIZE,X_IN_A_LINE):
        ...
        self.opp_all_states = [self.opp_winning_states,self.opp_one_step_to_winning,self.opp_defend_one_step_to_winning]
        self.all_states = [self.winning_states, self.one_step_to_winning, self.defend_one_step_to_winning]
